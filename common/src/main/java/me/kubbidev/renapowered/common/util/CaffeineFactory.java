...
public final class CaffeineFactory {
    ...
    /**
     * Our own fork join pool for RenaPowered cache operations.
     * <p>
     ...
     * or otherwise block waiting for something else to complete. This prevents the RenaPowered cache loading
